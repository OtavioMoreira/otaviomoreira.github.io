  ...
  const dataProjects = [
    {
      ...
      description: `O Portal B2B da Rede Ancora é uma plataforma de comércio digital voltada para o relacionamento entre a rede e seus parceiros comerciais.
      Atuo no desenvolvimento e evolução da plataforma como Desenvolvedor Full Stack Sênior, trabalhando com PHP/Laravel e Node.js no back-end,
      e React.js com TypeScript no front-end. Participo ativamente de decisões técnicas, definição de arquitetura, code reviews e
      otimização de performance utilizando Redis, RabbitMQ e Elasticsearch.`,
